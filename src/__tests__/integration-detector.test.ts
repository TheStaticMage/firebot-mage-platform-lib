...
describe("IntegrationDetector", () => {
    ...
    beforeEach(() => {
        ...
        // loadScriptVersion uses node:fs/node:path directly, so mock at import level
        (startupScriptsModule.loadScriptVersion as jest.Mock).mockReturnValue(
            "0.6.2"
        );
    ...
    describe("getAvailablePlatforms", () => {
        ...
        it("should include detected platforms", async () => {
            ...
            expect(platforms).toEqual(
                expect.arrayContaining(["twitch", "kick", "youtube"])
            );
        });
    });
    ...
    describe("getDetectedIntegrationInfo", () => {
        it("should return integration info for detected integration", async () => {
            ...
            expect(info).toEqual({
                ...
                version: "0.6.2", // Version loaded from mocked loadScriptVersion
    ...
    describe("checkIntegrationCompatibility", () => {
        ...
        it("should return incompatible for version mismatch", async () => {
            ...
            (startupScriptsModule.loadScriptVersion as jest.Mock).mockReturnValueOnce(
                "0.5.0"
            );
    ...
    describe("clear", () => {
        it("should clear detected integrations", async () => {
            const scripts = [{ name: "Kick Integration", scriptName: "kick.js" }];
